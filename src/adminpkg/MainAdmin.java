...
public abstract class MainAdmin{
    ...
    public static void createTestAccounts(){
        ...
        accountpkg.SavingsAccountModel savings1 = new accountpkg.SavingsAccountModel(1235, 10.0, 0.04);
        accountpkg.SavingsAccountModel savings2 = new accountpkg.SavingsAccountModel(5679, 15.0, 0.05);
        accountpkg.CheckingAccountModel checking3 = new accountpkg.CheckingAccountModel(1236, 20.0);
        ...
        checkingAccountList.add(checking3);
    }
    ...
    public static ArrayList getCheckingList(){
        return checkingAccountList;
    }
    
    public static ArrayList getSavingsList(){
