...
public class GenerateMainMenu extends JFrame implements ActionListener{
    ...
    JLabel account3Type = new JLabel("Checking");
    JLabel account4Type = new JLabel("Savings");
    JLabel account5Type = new JLabel("Savings");
    ...
    public void generateInfo(){
       ...
       accountpkg.CheckingAccountModel tempAccount1 = tempCheckingList.get(0);
       accountpkg.CheckingAccountModel tempAccount2 = tempCheckingList.get(1);
       accountpkg.CheckingAccountModel tempAccount3 = tempCheckingList.get(2);
       accountpkg.SavingsAccountModel tempAccount4 = tempSavingsList.get(0);
       accountpkg.SavingsAccountModel tempAccount5 = tempSavingsList.get(1);
       
       accountNumber1.setText(String.valueOf(tempAccount1.getAccountNumber()));
       accountNumber2.setText(String.valueOf(tempAccount2.getAccountNumber()));
       accountNumber3.setText(String.valueOf(tempAccount3.getAccountNumber()));
       accountNumber4.setText(String.valueOf(tempAccount4.getAccountNumber()));
       accountNumber5.setText(String.valueOf(tempAccount5.getAccountNumber()));
    }
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if(s.equals("Check Balance")){
            ...
            checkBalanceWindow.generateInfo();
            checkBalanceWindow.createFrame();
        }
        if(s.equals("Deposit")){
            depositWindow.generateInfo();
            depositWindow.createFrame();
        }
        if(s.equals("Withdrawal")){
            withdrawalWindow.generateInfo();
